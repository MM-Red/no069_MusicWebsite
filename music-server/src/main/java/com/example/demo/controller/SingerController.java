...
public class SingerController {
    ...
    public class MyPicConfig implements WebMvcConfigurer {
        ...
        public void addResourceHandlers(ResourceHandlerRegistry registry) {
            registry.addResourceHandler("/img/singerPic/**").addResourceLocations("file:D:\\BaiduNetdiskDownload\\前后端分离项目演示第三期绝对精美风的音乐网站\\music-website-master\\music-server\\data\\img\\singerPic\\");
        }
    }
